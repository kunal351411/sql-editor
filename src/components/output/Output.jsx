...
import { capitalizeString, fetchOutputColumns } from '../../utils/helpers/helpers'
        ...
        </div>
        {
          resultData.length > 0 && (
            ...
            <CSVLink
              ...
              >
                <div className='btn'>
                  <button type='button' className='export' >Export&emsp;<i className="fa fa-download"></i></button>
                </div>
              </CSVLink>
        </div>
          )
      ...
      <div className='table-container'>
        {
            !resultData.length ? (
                <div className='no-result'>
                    <h3><i className="fa fa-warning"></i>&emsp;{`Run Some Query to See Output !!!`}</h3>
                </div>
            ) : (
                <Table/>
            )
